...
printf("nprocs_recv=%d ADIOI_DS_WR_NAGGRS_LB=%d avg_recv_count=%lld ADIOI_DS_WR_NPAIRS_LB=%d\n",nprocs_recv,ADIOI_DS_WR_NAGGRS_LB,avg_recv_count,ADIOI_DS_WR_NPAIRS_LB);
